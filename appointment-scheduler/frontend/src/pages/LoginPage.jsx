      ...
      <div className="authCard">
        ...
        <div className="authHeader">
          ...
          <p className="authSubtitle">
            Inicia sesión para continuar gestionando tu agenda y pacientes de forma eficiente
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="authForm">
          ...
          <div className="formGroup">
            <div className="passwordHeader">
              ...
              <span className="forgotPassword" onClick={() => navigate('recuperar-password')}>
        ...
        <div className="authPrompt">
          ...
          <span className="authLink" onClick={() => navigate('registro')}>Regístrate ahora</span>
        </div>
      </div>
    </div>
  );
